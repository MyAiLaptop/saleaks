          ...
          <div className="max-w-2xl mx-auto px-4 py-16">
            <div className="bg-black/40 backdrop-blur-sm rounded-xl shadow-lg p-8 border border-white/10">
              ...
              <div className="bg-black/30 rounded-lg p-4 mb-6 border border-white/10">
                <p className="text-sm text-gray-400 mb-2">Your Leak ID:</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-amber-300 mb-4">
                        This token is shown only once. Save it to check messages from journalists.
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-primary-300 mt-1">
                  We do not log your IP address or collect any identifying information.
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                maxLength={500}
                placeholder="Brief headline describing the issue"
            ...
            <div>
              ...
              <textarea
                ...
                rows={8}
                maxLength={50000}
                placeholder="Describe what happened in detail. Include names, dates, locations, and any other relevant information. The more detail you provide, the more credible your report will be."
                className="w-full px-4 py-3 rounded-lg border border-white/20 bg-black/30 text-white placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                maxLength={200}
                placeholder="Company name, government department, etc. (optional)"
                className="w-full px-4 py-3 rounded-lg border border-white/20 bg-black/30 text-white placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <label htmlFor="enableContact" className="text-sm text-gray-300">
                ...
                <span className="text-gray-400">
                  Allow journalists to contact you anonymously. You&apos;ll receive a secret token
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-300 mb-4">
                    If your content generates revenue (media licensing, syndication), you can opt to share in the proceeds.
                  ...
                  <div className="space-y-3">
                    ...
                    <label className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-0.5">
                          SA Leaks keeps 100% of any revenue. Your identity remains completely protected.
                        </p>
                      </div>
                    </label>
                    ...
                    <label className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-400 mt-0.5">
                          SA Leaks will contact you if your content generates revenue to arrange payment.
                        </p>
                      </div>
                    </label>
