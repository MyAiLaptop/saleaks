  ...
  const plans = [
    {
      ...
      cta: 'Current Plan',
      ctaLink: `/${country}/browse`,
      highlighted: false,
    },
    {
      name: 'Journalist Pro',
      description: 'For individual journalists',
      price: country === 'sa' ? 'R299' : `${config.currencySymbol}20`,
      period: '/month',
      features: [
      ...
      cta: 'Get Started',
      ctaLink: `/${country}/journalists`,
      highlighted: true,
    },
    {
      name: 'Newsroom',
      description: 'For news organizations',
      price: country === 'sa' ? 'R1,999' : `${config.currencySymbol}150`,
      period: '/month',
      features: [
